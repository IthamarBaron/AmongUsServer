...
public class Client
{
    ...
    public class TCP
    {
        ...
        /// <summary>Initializes the newly connected clients TCP related info.</summary>
        ...
        private void ReceiveData(IAsyncResult _result)
        {
            ...
            {
                Debug.Log("Disconnected from [Client.cs] -> ReciveCallback() -> {Catch}");
